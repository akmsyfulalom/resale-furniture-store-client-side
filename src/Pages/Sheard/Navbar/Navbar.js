        ...
        <div className=' px-10 text-white bg-gradient-to-r from-secondary to-primary'>
            <div className="navbar px-2 ">
                <div className="navbar-start">
                    ...
                    <Link to='/' className=" normal-case text-xl font-mono font-bold">Resale furniture store</Link>
                </div>
                ...
                <div className="navbar-end">
                    ...
                    {
                        dashboard ? <label htmlFor="dashboard-sidebar-drawer" tabIndex={2} className="btn btn-ghost  lg:hidden">
